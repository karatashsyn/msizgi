...
export default async function Pedodonti({ params: { locale } }) {
  ...
  return (
    <main className="animate-fade-in-up mb-[7rem]">
      ...
      >
        <img
          src="/images/info/ortodonti/1.webp"
          alt="Ortodonti"
        ...
        >
          <h1
            ...
            dangerouslySetInnerHTML={{ __html: t("info:service4-title") }}
          ></h1>
        </div>
      </div>
      <PaddedContainer className={"mt-[5rem]"}>
        <div className="flex max-sm:flex-col max-md:gap-[1rem] gap-[4.15rem]">
          ...
          <div className="info-article text-[#52575D] leading-[1.3rem]">
            <article>
              <p>{t("info:service4-paragraph1")}</p>
              <div className="flex max-lg:flex-col gap-[1.25rem]">
                <img
                  ...
                  src="/images/info/ortodonti/2.webp"
                />
                <p>{t("info:service4-paragraph2")}</p>
              </div>
              <p>{t("info:service4-paragraph3")}</p>
              <p>{t("info:service4-paragraph4")}</p>
              <p>{t("info:service4-paragraph5")}</p>
              <img
                alt="Ortodonti"
                className="w-full max-h-[24rem] object-cover"
                src="/images/info/ortodonti/3.webp"
              />
              <div className=" flex mt-[1rem] max-w-full gap-[1rem]">
                ...
                {[...Array(5)].map((_, i) => (
                  <img
                    ...
                    src={`/images/info/ortodonti/${i + 4}.webp`}
                  />
                ))}
              </div>
            </article>
